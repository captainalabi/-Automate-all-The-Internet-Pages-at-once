...
await browser.pause(2000)
        ...
        it('3. Add/Remove Elements', async () => {
...
it('7. click disabled when the button is clicked again -wait for disabled', async () => {
...
it('8. Remove/add -wait until', async () => {
...
it('9. to expect the text to change back to Remove when clicked again', async () => {
    await MainPagePage.clickRemoveAddButton()
...
/*
it('12. Should switch to iframe, set and confirm text ', async () => {
    //go back to nain page
    MainPagePage.open()
   
       //navigate to Frames
       await MainPagePage.clickAnchorLink(22);
       await browser.pause(5000)
   
       //click the iframe link
       await MainPagePage.clickIframeLink()
       await browser.pause(5000)
   
       //switch to frmae
       await MainPagePage.switchToIFrame()
       await browser.pause(5000)
   
       await MainPagePage.clickIframeBody()
       await MainPagePage.iframeBody.clearValue()
       await iframeBody.setValue('Good Morning')
       await browser.pause(5000)
       await expect(MainPagePage.iframeBody).toHaveText('Good Morning')
   })
   */
    })
